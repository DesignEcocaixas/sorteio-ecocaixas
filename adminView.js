module.exports = function renderAdminView(leads = [], ganhador = null, erro = null, msg = null) {
    ...
    // Preparando os dados para a animação
    ...
    <head>
        ...
        <style>
            ...
            /* Shake Animação com Intervalo (Apenas 10% do tempo está tremendo) */
    ...
    <body class="bg-gray-50 font-sans text-gray-800 min-h-screen">
            ...
            <div class="container mx-auto flex justify-between items-center">
                <h1 class="text-xl font-bold flex items-center gap-3">
                    <div class="bg-white p-1 rounded-lg shadow-sm flex items-center justify-center">
                        <img src="/img/eco.png" alt="Logo Ecocaixas" class="h-6 w-auto object-contain">
                    </div>
                    Sorteio Ecocaixas
                </h1>
        ...
        <div class="container mx-auto p-6 max-w-5xl mt-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-1 mb-1 text-center">
        ...
        <div id="modalSorteio" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-md hidden">
            <!-- Modal Reduzido: max-w-lg (no lugar de max-w-3xl) e p-6 -->
            <div id="modalContent" class="bg-white rounded-3xl shadow-2xl p-6 max-w-lg w-full mx-4 text-center transform scale-95 transition-transform duration-300">
                
                <div id="faseEmbaralhando" class="py-6">
                    <h3 class="text-lg text-gray-500 font-bold mb-4 uppercase tracking-widest text-emerald-500 animate-pulse">Sorteando...</h3>
                ...
                <div id="faseGanhador" class="hidden">
                    ...
                    <h3 class="text-emerald-600 font-black text-xl uppercase tracking-wider mb-1">Temos um vencedor!</h3>
                    
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-5 my-4 shadow-inner">
                        <p class="text-sm text-gray-500 mb-2">A pizzaria ganhadora é:</p>
                        
                        <!-- NOME EM DESTAQUE COM ANIMAÇÃO DE SHAKE -->
                        <div class="animate-shake-interval">
                            <h2 id="nomeGanhadorFinal" class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-green-600 drop-shadow-sm mb-4 break-words" style="font-family: 'Poppins', sans-serif;"></h2>
                        </div>
                        <br>
                        
                        <a id="instaGanhadorFinal" href="#" target="_blank" class="inline-block bg-white text-emerald-600 font-bold py-2 px-5 rounded-xl shadow-md border border-emerald-200 hover:bg-emerald-50">
                            @instagram
                        </a>
                    </div>
                    
                    <div class="bg-gradient-to-r from-orange-400 to-pink-500 text-white font-bold text-lg py-2 px-4 rounded-xl mb-6 shadow-md animate-pulse">
                        🎁 Ganhou 100 Caixas!
                    </div>

                    <button onclick="fecharModal()" class="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 rounded-xl transition-colors relative z-10 text-lg">
                        Fechar
                    </button>
                </div>
            </div>
        ...
        <script>
            ...
            function iniciarAnimacaoSorteio() {
                ...
                const alturaDoItem = 48; // Altura ajustada
                ...
                caracteresNome.forEach((char, index) => {
                    ...
                    // Aumentamos consideravelmente a quantidade de itens para demorar mais
            ...
            function revelarGanhador() {
                ...
                // Som foi removido como solicitado

                // Dispara a chuva de adesivos
